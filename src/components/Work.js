        ...
        <div className="card-row">
          ...
          >
            ...
            <p className="description">
              I am committed to writing clean and efficient code that
              doesn&apos;t only save my time in debugging my code and pushing
              updates, also helps fellow developers to collaborate with me
              easily.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p className="description">
              ...
              rapidly evolving timeline as I have worked in multiple programming
          ...
          >
            ...
            <p className="description">
              To be honest, I have done Most projects for myself, I&apos;ve also
              worked in teams, and Recoded Bootcamp taught me a lot about time
              management, I&apos;m looking forward to getting more projects.
            </p>
          </div>
        </div>
      </div>
